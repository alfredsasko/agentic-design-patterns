...
def run_reflection_loop(llm_client=None, max_iterations: int = 3) -> str:
    """
    ...
    for i in range(max_iterations):
        ...
        if i == 0:
            ...
            response = llm_client.invoke(message_history)
        ...
        critique_response = llm_client.invoke(reflector_prompt)
